...
ANDROID_EXCLUDE_C += src/crypto/rand_extra/fuchsia.c
ANDROID_EXCLUDE_C += src/crypto/rand_extra/windows.c
ANDROID_EXCLUDE_C += src/crypto/rand_extra/deterministic.c
